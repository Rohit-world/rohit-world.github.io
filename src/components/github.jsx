...
const Github = () => {
    return (
        <div   className='w-full  text-white pt-20 pb-10 backdrop-blur-md '>
        <div className=' max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full'>
            <div>
                <p className='text-4xl font-bold  text-transparent bg-gradient-to-b from-orange-500 to-yellow-300 bg-clip-text  p-b '>GitHub </p>
